...
class FixedBitNotation
{
     ...
     */
    public function __construct(int $bitsPerCharacter, string $chars, bool $rightPadFinalBits = false, bool $padFinalGroup = false, string $padCharacter = "=")
    {
        // Ensure validity of $chars
        if (!$chars || ($charLength = strlen($chars)) < 2) {
